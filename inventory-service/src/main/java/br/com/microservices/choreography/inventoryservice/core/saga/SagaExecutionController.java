...
public class SagaExecutionController {
    ...
    private void handleRollbackPending(Event event) {
        log.info("### CURRENT SAGA: {} | SENDING TO ROLLBACK CURRENT SERVICE | NEXT TOPIC {} | {}",
                event.getSource() /*serviços atual*/, inventoryFailTopic /*tópico passado*/, createSagaId(event) /*composto porId do pedido, id da transação e o id do evento */  );
    ...
    private void handleFail(Event event) {
        ...
        log.info("### CURRENT SAGA: {} | SENDING TO ROLLBACK PREVIOUS SERVICE | NEXT TOPIC {} | {}",
                event.getSource() /*serviços atual*/, paymentFailTopic /*tópico passado*/, createSagaId(event) /*composto porId do pedido, id da transação e o id do evento */  );
