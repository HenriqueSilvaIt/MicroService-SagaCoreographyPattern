...
public class KafkaProducer {
    ...
    @Value("${spring.kafka.topic.orchestrator}") /*oRCHESTRATOR é único producer
    desse serviço, como ele é
    ...
    public void sendEvent(String payload) {
        try {
            ...
            /*envio do evento*/
            kafkaTemplate.send(orchestratorTopic, payload); /*send recebe o nome do tópico e o payload*/
